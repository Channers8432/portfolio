            ...
            {open && (
                ...
                >
                    ...
                    >
                        ...
                        <div onClick={(e) => e.stopPropagation()} className="w-full md:w-80 h-80 shrink-0 bg-cta-bg rounded-[2rem] border border-border-default shadow-2xl p-8 overflow-y-auto space-y-4">
