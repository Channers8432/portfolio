                ...
                <div className="flex-1 space-y-4">
                  <div className="text-sm text-text-secondary space-y-4 leading-relaxed">
                    ...
                    <p>
                      ...
                      the Technical Unit, Water Unit, Criminal Assets Buerea, and the Detective Bureau, all of which have been drawn out as closely as possible to real life uniforms.
                    </p>
                  </div>
                </div>
              </div>
