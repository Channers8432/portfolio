          ...
          <div className="flex flex-col gap-5 pt-2">
            <div className="flex flex-row gap-4 w-full">
              ...
              <a
                ...
                className="flex-1 bg-text-primary hover:bg-button-bg-transparent-hover border border-border-default text-bg-primary px-4 py-4 rounded-2xl font-bold text-sm md:text-base transition-all flex items-center justify-center gap-2 whitespace-nowrap"
              >
                <Mail size={18} />
                Get in Touch
              </a>
